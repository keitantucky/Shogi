...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Ecom", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Ecom_Transaction_Release"))
	static void EOSEcomTransactionRelease(UObject* WorldContextObject, const FEOSEcomHTransaction& Handle);
